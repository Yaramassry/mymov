...
/*constructor(){
 ...
 /*handleIncrement = id => {
   //لا يمكننا تغيير البروبس فاليو هكذاthis.props.value=0;
   //console.log(id);
...
render() { 
  ...
  borderBottom: "1px solid rgb(158, 38, 74)",
  fontWeight: "bold",
  border: "none",
  ...
  // console.log("props",this.props );  <button  style={mystyle}


    /* onClick={() => this.handleIncrement(this.handleIncrement.id)}>
     Downloads
    </button>*/


   return (
   <div className="toolbar__button__span" >
  ...
  <br/><br/>
    ...
    <button onClick={this.props.increment} style={mystyle}>
     Downloads
    </button>
...
//لاظهار الشيلدرين<h3> {this.props.children}</h3>